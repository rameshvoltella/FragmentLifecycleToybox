 ...
 */
public class MyFragmentDynamic extends MyFragment
{
	...
	public MyFragmentDynamic() {
		trace.log("MyFragmentDynamic()", String.format("MyFragmentDynamic(NEW)=%s",
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		trace.log("onCreateView()",
			String.format("MyFragmentDynamic: container=%s", Trace.classAtHc(container)));
	...
	public class InfoImpl implements Trace.Info
	{
		...
		public String getData() {
			MyFragmentDynamic mf = (MyFragmentDynamic) obj;
